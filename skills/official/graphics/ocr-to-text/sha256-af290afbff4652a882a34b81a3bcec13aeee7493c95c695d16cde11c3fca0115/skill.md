...
icon: scan-text
llm-hint: "Fires on file drop. Runs Tesseract OCR on local images (png/jpg/jpeg/tiff/bmp/gif/webp), including screenshots and scans, and saves extracted text as a .txt file in ~/Documents/ocr/. Returns {saved_path}. Local-only, no network."
