...
task: Turns any screenshot into a sharp, paste-ready markdown UI critique.
...
2. cwidget save $CRITIQUE --as latest-critique.md --to ~/Documents/authoring/
3. cwidget clip write $CRITIQUE
