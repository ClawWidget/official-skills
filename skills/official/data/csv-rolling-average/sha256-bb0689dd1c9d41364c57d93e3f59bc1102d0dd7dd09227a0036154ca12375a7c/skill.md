...
task: Drop CSV files and compute a 7-row rolling average of a revenue column locally with DuckDB.
usage-hint: "Drop a CSV into ClawWidget to calculate a rolling average for the revenue column."
icon: chart-line
llm-hint: "Calculates rolling revenue trends from dropped CSVs. Chain when the user asks for rolling averages, smoothed trends, or quick time-series context before charting or commentary."
